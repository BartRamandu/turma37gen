package BaseInicioSemPOO;

import java.util.Locale;
import java.util.Scanner;

public class ClubeDosCincoBase {
			...
			if (op == "S"){
				...
				do { 
					...
					do{	
						...
						if (quantidade<=0){
							System.out.print("Quantidade inexistente, digite um valor válido.\n");
						}else if (quantidade>estoque[codUsuario]){
							System.out.print("Quantidade indisponível no estoque, deste produto restam apenas "+estoque[codUsuario]+" unidades na loja. Tente novamente.\n");
						}
